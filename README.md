...
- binary: pulumi-resource-neon
  ...
  ignore: []
  ldflags:
  - -X github.com/jcgsville/pulumi-neon/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-neon_darwin_amd64_v1
│   └── pulumi-resource-neon
├── pulumi-neon_darwin_arm64
│   └── pulumi-resource-neon
├── pulumi-neon_linux_amd64_v1
│   └── pulumi-resource-neon
├── pulumi-neon_linux_arm64
│   └── pulumi-resource-neon
├── pulumi-neon_windows_amd64_v1
│   └── pulumi-resource-neon.exe
└── pulumi-neon_windows_arm64
    └── pulumi-resource-neon.exe
```
