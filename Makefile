...
prepare::
	...
	if [[ "${OS}" != "Darwin" ]]; then \
		sed -i 's,github.com/pulumi/pulumi-neon,${REPOSITORY},g' provider/go.mod; \
...
tfgen:: install_plugins
	(cd provider && go build -o $(WORKING_DIR)/bin/${TFGEN} -ldflags "-X ${PROJECT}/${VERSION_PATH}=${VERSION}" ${WORKING_DIR}/${PROVIDER_PATH}/cmd/${TFGEN})
